...
<style>
#addToolError, .editToolError, .delete-btn, .icon-remove, .sound-section, #file_type_error, #minimum_file_error, #max_file_warning_mp3, #max_file_warning_wav, #max_file_warning_stem{
  display:none;
}
.pac-container{
...
<script>
  ...
  function add_more(file_type){
    ...
    $('#' + file_type + '_sound_section').append('<div class="sound-file" id="' + file_type + '-sound-file-' + add_file_index + '"><div class="row"><div class="col-md-12"><input type="file" required name="' + file_type + '_file[]" onchange="show_add_more(' + "'" + file_type + "-" + add_file_index + "'" + ');" accept="' + accept_file + '" ></div></div><div class="icon-remove" id="icon-remove-' + file_type + '-' + add_file_index + '" ><button type="button" class="btn" onclick="add_more(' + "'" + file_type + "'" + ');" id="' + file_type + '-add-btn-' + add_file_index + '" ><i class="fa fa-plus" aria-hidden="true"></i></button><button type="button" class="btn delete-btn" onclick="delete_file(' + "'" + file_type + "', " + add_file_index + ');" id="' + file_type + '-delete-btn-' + add_file_index + '" ><i class="fa fa-times" aria-hidden="true"></i></button></div>');
