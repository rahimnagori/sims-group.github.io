...
<div class="player-container">
  ...
  <h2 id="title_old"></h2>
  <audio src="" ontimeupdate="update_time(this.currentTime, this.duration);" ></audio>
  <!-- Controls -->
  <!--
...
<script src="<?=site_url();?>assets/site/js/player.js?time=<?=time();?>" type="text/javascript"></script>