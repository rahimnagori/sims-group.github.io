              ...
              ?>
                  <div class="item">
                    <div class="destination">
                      <a href="<?=$BASE_URL .'Collections/' .$subCategory['id'];?>" class="img d-flex justify-content-center align-items-center" style="background-image: url(<?=$BASE_URL .$subCategory['icon'];?>);">
                        <div class="icon d-flex justify-content-center align-items-center">
                          <i class="fa fa-play-circle-o" aria-hidden="true"></i>
                        </div>
                      </a>
                      <div class="text p-3">
                        <h3><a href="<?=$BASE_URL .'Collections/' .$subCategory['id'];?>"><?=$subCategory['name'];?></a></h3>
                      </div>
                    </div>
                  </div>
              <?php
