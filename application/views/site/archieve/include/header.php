  ...
  <div class="container">
    ...
    <div class=" navbar-collapse" id="ftco-nav">
      <ul class="navbar-nav ml-auto" id="manuu_dow">
        ...
        <li class="nav-item"><a href="javascript:void(0);" class="nav-link link">Collections</a>
          <ul class="submenu ">
            <?php
              foreach($collections as $collection){
            ?>
                <li class="nav-item submenu_item"><a href="<?=$BASE_URL;?>Collection-Details/<?=$collection['id'];?>" class="nav-link"><?=$collection['collection_name'];?></a></li>
            <?php
              }
            ?>
          </ul>
