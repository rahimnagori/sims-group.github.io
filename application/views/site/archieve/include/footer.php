			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
						<li class="ftco-animate"><a href=" https://twitter.com/the_auxhole" target="_blank"><span class="icon-twitter"></span></a></li>
						<li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
						<li class="ftco-animate"><a href="#"><span class="icon-instagram"></span></a></li>
            <li class="ftco-animate"><a href="https://www.youtube.com/channel/UCFm43ksCl9ASqAS4BTy3lBg" target="_blank"><span class="icon-youtube"></span></a></li>
					</ul>
				</div>
			</div>
			<div class="col-md">
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<div class="block-23 mb-3">
						<ul>
							<li><span class="icon icon-map-marker"></span><span class="text">20028 N.W. 64th pl, Hialeah 33015</span></li>
							<li><a href="#"><span class="icon icon-phone"></span><span class="text">(786) 544-6064</span></a></li>
							<li><a href="#"><span class="icon icon-envelope"></span><span class="text"><span class="__cf_email__" data-cfemail="b4dddad2dbf4cddbc1c6d0dbd9d5ddda9ad7dbd9">theauxhole@gmail.com</span></span></a></li>
						</ul>
					</div>
				</div>
			</div>
...
<script>
  ...
  function like_dislike(sound_id, refreshPage = false){
    $.ajax({
      type: "POST",
      dataType: 'JSON',
      url: base_url + "Audios/like_dislike",
      data: {
        'sound_id': sound_id
      },
      beforeSend: function() {
      ...
      success: function(response) {
        if(response.status == 1){
          $("#like_dislike_" + sound_id).html(response.icon);
          if(refreshPage){
            location.reload();
          }
        }
...
<script type="text/javascript">
  ...
  function open_player(collection_id = false){
    if(!collection_id){
